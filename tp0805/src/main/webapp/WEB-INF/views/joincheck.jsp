...
function box_check() {
	var agree1 = document.getElementById('chk1');
	var agree2 = document.getElementById('chk2');
	if(agree1.checked == false) {
		alert("이용 약관에 동의해주세요.");
		return false;
	} 
	if(agree2.checked == false) {
		alert("정보 취급 방침에 동의해주세요.");
		return false;
	} 
	
	window.location.replace("/homejoin/adduser");
...
<style>
	.info { font-size : 140%; font-weight: bold; text-aligen: left;}
	.test2{ padding-top: 80px; }
</style>
</head>
<body>
...
<div class="container-fluid">
	<div class="row">
	    ...
	    <p class="info">KIDULT 이용약관<img src="/assets/img/로고.png" alt="KIDULT logo" style="margin-left: 45%; width: 15%;"></p>
	    
	    <hr />
	    <div class="text-center">
	    	<textarea cols="60" rows="10">인터넷 쇼핑몰 『KIDULT』회원 약관

제1조(목적)
이 약관은 주식회사 KIDULT 회사(전자상거래 사업자)가 운영하는 주식회사 KIDULT 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.

  ※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다.」

제2조(정의)
① “몰”이란 주식회사 KIDULT 회사가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
...
① “몰”은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호·모사전송번호·전자우편주소, 사업자등록번호, 통신판매업 신고번호, 개인정보보호책임자 등을 이용자가 쉽게 알 수 있도록 주식회사 스킨푸드 사이버몰의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.
...
본 약관은 2021년08월26일부터 적용됩니다.
</textarea><br/>
	    	<input type="checkbox" id="chk1" name="chk"/> 이용 약관에 동의합니다
	    </div>
	    <br />
	    <br />
	    <p class="info">개인정보 취급 방침 안내<img src="/assets/img/로고.png" alt="KIDULT logo" style="margin-left: 30%; width: 15%;"></p>
	    <hr />
	    <div class="text-center">
	    	<textarea cols="60" rows="10">[개인정보 수집 및 이용 동의]

㈜KIDULT는 다음과 같이 개인정보를 수집 및 이용하고 있습니다.

- 수집 및 이용 목적: 회원 가입, 게임서비스 제공, 회원 관리, 고지사항 전달
- 항목: ID, 비밀번호, E-mail

- 수집 및 이용 목적: 본인 확인, 명의도용 및 부정이용 방지 등 회원 관리, 고지사항 전달
...
위와 같이 수집하는 개인정보에 대해 동의를 거부할 경우 회원가입이 불가능 합니다.
이벤트 등 프로모션 알림 전송을 위해 선택적으로 개인정보를 이용할 수 있습니다.

※ 그 외의 사항 및 자동 수집 정보와 관련된 사항은 개인정보처리방침을 따릅니다.</textarea><br/>
	  	 	<input type="checkbox" id="chk2" name="chk"/> 개인정보 방침에 동의합니다
	    </div>
	    <br />
	    <br />
	    <hr />
	    <div class="text-center">
	    	<input type="checkbox" id="chkAll" name="chkAll" /> 전부 동의합니다
	    </div>
	    <br/>
	    <button type="button" class="btn btn-info btn-block mb-4" onclick="box_check()">다음</button>
	    </div>
	    <div class="col test1"></div>
	</div>   
</div>
