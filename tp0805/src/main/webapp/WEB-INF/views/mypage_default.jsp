...
<script>
	...
	function customer_page() {
		window.location.replace("/customer_page");
	}
	// 마이페이지
	function userpage() {
...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-3">
            	<h2 style="margin-top: 8%;">마이페이지</h2>
                <h4 style="margin-top: 8%;">회원 정보</h4>
                <a onclick="pwcheck()" style="text-decoration-line: none; color: inherit;"> 
                    <h5 style="margin-top: 25px; font-size: 13pt; text-decoration:none;"> 내정보 조회/수정 </h5> 
                </a>
                <hr style="width: 70%; color: gray;">
                <a onclick="notice()" style="text-decoration-line: none; color: inherit;"> 
                    <h5 style="margin-top: 16px; font-size: 13pt; text-decoration:none;"> 비밀번호 변경 </h5> 
                </a>
                <hr style="width: 70%; color: gray;">
                <a onclick="wish()" style="text-decoration-line: none; color: inherit;"> 
                    <h5 style="margin-top: 16px; font-size: 13pt; text-decoration:none;"> 찜목록 </h5> 
                </a>
                <hr style="width: 70%; color: gray;">
                <a onclick="notice()" style="text-decoration-line: none; color: inherit;"> 
                    <h5 style="margin-top: 16px; font-size: 13pt; text-decoration:none;"> 나의 리뷰 </h5> 
                </a>
                <hr style="width: 70%; color: gray;">
                <h4 style="margin-top: 8%;">주문 정보</h4>
                <a onclick="go_cart()" style="text-decoration-line: none; color: inherit;"> 
                    <h5 style="margin-top: 25px; font-size: 13pt; text-decoration:none;"> 장바구니 </h5> 
                </a>
                <hr style="width: 70%; color: gray;">
                <a onclick="notice()" style="text-decoration-line: none; color: inherit;"> 
                    <h5 style="margin-top: 16px; font-size: 13pt; text-decoration:none;"> 주문내역 </h5> 
                </a>
                <hr style="width: 70%; color: gray;">
                <a onclick="userAddress()" style="text-decoration-line: none; color: inherit;"> 
                    <h5 style="margin-top: 16px; font-size: 13pt; text-decoration:none;"> 배송지 관리 </h5> 
                </a>
                <hr style="width: 70%; color: gray;">
                <h4 style="margin-top: 8%;">고객센터</h4>
                <a onclick="notice_view()" style="text-decoration-line: none; color: inherit;"> 
                    <h5 style="margin-top: 25px; font-size: 13pt; text-decoration:none;"> 공지사항 </h5> 
                </a>
                <hr style="width: 70%; color: gray;">
                <a onclick="customer_page()" style="text-decoration-line: none; color: inherit;"> 
                    <h5 style="margin-top: 16px; font-size: 13pt;"> 1:1 문의 </h5> 
                </a>
                <hr style="width: 70%;">
            ...
            <div class="col-sm-7">
	            <h2 style="font-size: 18pt; margin-top: 5%;"> 마이페이지
	            </h2> 
	            <hr style="margin-bottom: 30px;">
	            	<c:choose>
							<c:when test="${uinfo.mid != null}">
								${uinfo.mname} 님 안녕하세요.<br/>
							</c:when>
							<c:otherwise>
