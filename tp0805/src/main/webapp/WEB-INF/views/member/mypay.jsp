...
<!-- End Header -->
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-7">
	            <h2 style="font-size: 18pt; margin-top: 5%;"> 구매 내역
	            </h2> 
						...
						<tbody>
							<c:choose>
								<c:when test="${list != null}">  
									<c:forEach items="${list}" var="odto" varStatus="st">
										<tr>
											<td><img width="150px;" src="/upload/${odto.cPhoto1}" /></td>
											<td><a href="/member/mypay_info?pid=${odto.pId}">${odto.cName}</a></td>
											<td>${odto.cPrice} 원</td>
											<td>${odto.pCount} 개</td>
