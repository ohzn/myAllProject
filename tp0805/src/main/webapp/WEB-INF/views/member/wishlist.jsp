...
<!-- End Header -->
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-7">
	            <h2 style="font-size: 18pt; margin-top: 5%;"> 찜목록
	            </h2> 
						...
						<c:when test="${list != null}">
							...
							<div class="row">
								<div class="col-sm-2" style='margin: auto; text-align:left;'>
									<img width="100px;" src="/upload/${dto.cPhoto1}" />
								</div>
								<div class="col-sm-6" style='margin: auto; text-align:left;'>
									<a href="/goods/goods_view?cId=${dto.cId}">상품명 : ${dto.cName}</a><input type="hidden" id="cId" name="cId" value="${dto.cId}" /><br/>
									<br/>
									가격 : ${dto.cPrice} 원<br/>
								</div>
								<div class="col-sm-2" style='margin: auto; text-align:center;'>
									<button type=button class="btn btn-danger btn-sm" onclick="del_wish('${dto.cId}')" style="float: right;">삭제</button>
								</div>
							</div>
