...
<body>
    ...
    <p style="margin-left: 16%; font-size: 5pt;"> > 전체보기 </p>
    <h3 style="text-align: center; margin-top: 2%;"><strong>전체 상품</strong></h3>
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <ul style="list-style: none; margin-top: 5%;">
                	<li>
                        <label>
                            <input type="radio" id="sortDate" name="sortDate" checked onclick="allgoods_list()">
                            <span>최신순</span>
                        </label>
                    </li>
                    <li>
                        <label>
                            <input type="radio" id="sortSale" name="sortSale">
                            <span>인기순</span>
                        </label>
                    </li>
                    <li>
                        <label>
                            <input type="radio" id="sortRowprice" name="sortRowprice">
                            <span>낮은 가격순</span>
                        </label>
                    </li>
                    <li>
                        <label>
                            <input type="radio" id="sortHighprice" name="sortHighprice">
                            <span>높은 가격순</span>
                        </label>
                    </li>
                </ul>
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body p-4">
                            <div class="text-center">
						        ...
						        <c:if test="${today - dtoDate le 10}"><!-- 1일동안은 new 표시 -->
		...
		<div class="row">
			...
			<nav aria-label="Page navigation example">
				<ul class="pagination justify-content-center">
		            ...
		            <c:otherwise>
		            	<li class="page-item">
		                	<a class="page-link" href="goods_list?page=1" aria-label="Previous">
		                  		<span aria-hidden="true">&laquo;</span>
		                	</a>
		            	</li>
					</c:otherwise>
					...
					<c:otherwise>
						<li class="page-item">
		            		<a class="page-link" href="goods_list?page=${page.curPage - 1}">Previous</a>
		            	</li>
					</c:otherwise>
					</c:choose>
		            ...
		            <c:forEach var="fEach" begin="${page.startPage}" end="${page.endPage}" step="1">
						...
						<c:when test="${page.curPage == fEach}">
							...
							<c:otherwise>
		            <li class="page-item">
		            	<a class="page-link" href="goods_list?&page=${fEach}">${fEach}</a>
		            </li>
		            </c:otherwise>
						</c:choose>
					</c:forEach>
					...
					<c:otherwise>
						<li class="page-item">
		                	<a class="page-link" href="goods_list?page=${page.curPage + 1}">Next</a>
		            	</li>
					</c:otherwise>
					</c:choose>
					...
					<c:otherwise>
						<li class="page-item">
		                	<a class="page-link" href="goods_list?page=${page.totalPage}" aria-label="Next">
		                  	<span aria-hidden="true">&raquo;</span>
		                	</a>
		            	</li>
					</c:otherwise>
