...
<%!
    String clientId = "5A_RfiREmcDxGZ814fnW"; //애플리케이션 클라이언트 아이디값";
	String clientSecret = "vtv55Q7sPY"; //애플리케이션 클라이언트 시크릿값";
    ...
    public String captchaImage(String key, String dirPath) {
        ...
        try {
            ...
            if (responseCode == 200) { // 정상 호출
                ...
                // 랜덤한 이름으로 파일 생성
                //dirPath="C:\BigData\apache-tomcat-9.0.62-windows-x64\apache-tomcat-9.0.62\wtpwebapps\FirstWebProject\captchaImage";
