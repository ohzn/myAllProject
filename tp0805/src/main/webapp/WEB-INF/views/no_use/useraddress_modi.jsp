...
<!-- End Header -->
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-7">
	            <h2 style="font-size: 18pt; margin-top: 5%;"> 배송지 수정
	            </h2> 
	            <hr style="margin-bottom: 30px;">
	            	<form id="adr_frm">
						<input type="hidden" id="mId" name="mId" value="${uinfo.mid}"> <br/>
						배송지 이름 : <input type="text" id="aName" name="aName" placeholder="배송지 이름" value="${modiform.aName}">
						수령인 이름 : <input type="text" id="adrName" name="adrName" placeholder="수령인 이름" value="${modiform.adrName}">
						
						<c:choose>
							<c:when test="${modiform.aPrimary == '1'}"> 
								<input type="radio" id="aPrimary" name="aPrimary" value="1" checked /> 주 배송지<br>
							</c:when>
							<c:otherwise>
						...
						우편 번호 : <input type="text" id="aZipcode" name="aZipcode" onclick="sample6_execDaumPostcode()" placeholder="우편번호" value="${modiform.aZipcode}">
						<input type="button" onclick="sample6_execDaumPostcode()" value="우편번호 찾기"><br>
						주소 : <input type="text" id="aMain" name="aMain" placeholder="주소" value="${modiform.aMain}"><br>
						상세주소 : <input type="text" id="aSub" name="aSub" placeholder="상세주소" value="${modiform.aSub}">
						<br>
						<button type=button onclick="modi_address()">배송지 수정하기</button>
					</form>
            </div>
        </div>
    </div>
