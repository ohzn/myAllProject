						...
						<div class="col-10 test2">
							...
							<hr style="color: white; padding-top: 20px; padding-bottom: 20px;">
								<div class="col-sm-5" style='margin: auto; text-align:left;'>
									...
									<hr style="color: gray;" />
									<p class="text1">총 주문 금액 : ${pay.totalPrice} 원</p>
								</div>
								<div class="col-sm-5" style='margin: auto; text-align:left;'>
									<h5 style="font-weight:bold; padding-bottom: 15px;">배송지 정보</h5><br/>	
									<p class="text1">수령인 이름 : ${pay.adrName}</p>
									<p class="text1">(${pay.aZipcode}) ${pay.aMain}</p>
									<p class="text1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${pay.aSub}</p>
								</div>
								<hr style="color: white; padding-top: 20px; padding-bottom: 20px;">
								<hr style="color: gray;">
								<hr style="color: white; padding-top: 20px; padding-bottom: 20px;">
