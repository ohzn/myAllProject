...
function form_check() {
   	oEditors.getById["cDetail"].exec("UPDATE_CONTENTS_FIELD", []);
   	console.log("goods_write");
...
<script>
	function input_goods2() {
		var cName = $("input[name=cName]").val();
		var cPrice = $("input[name=cPrice]").val();
		var cCount = $("input[name=cCount]").val();
...
<!-- End Header -->
	...
	<div class="container">
        <div class="row">
            ...
            <div class="col-sm-7">
	            <h2 style="font-size: 18pt; margin-top: 5%;"> 상품 등록 </h2> 
	            <hr style="margin-bottom: 5%;">
	            <form style="margin-left: 5%;" id="goods_form" method="post" action="/admin/goods_write" enctype="multipart/form-data">
		            <select id="kind" name="kind" class="form-select form-select-sm" aria-label=".form-select-sm example">
					  <option selected>상품 분류</option>
					  <option value="전자게임">전자게임</option>
					  <option value="교육완구">교육완구</option>
					</select>
		            <span style="margin-right: 3%; margin-bottom:1%;">상품 이름</span> 
		            <input type="text" id="cName" name="cName" style="margin-bottom:1%;"><br>
		            
		            <span style="margin-right: 3%; margin-bottom:1%;">상품 가격</span> 
		            <input type="text" id="cPrice" name="cPrice" style="margin-bottom:1%;"><br>
		            
		            <span style="margin-right: 3%; margin-bottom:1%;">상품 수량</span> 
		            <input type="text" id="cCount" name="cCount" style="margin-bottom:1%;"><br>
		            
		            <span style="margin-right: 3%; margin-bottom:1%;">상품 설명</span> 
		            <textarea type="text" class="form-control"
							  id="cDetail" name="cDetail"
							  style="width: 100%; height: 10%; margin-top: 30%;"> </textarea>
					<script type="text/javascript">
						var oEditors = [];
						nhn.husky.EZCreator.createInIFrame({
						    oAppRef: oEditors,
						    elPlaceHolder: "cDetail",
		            ...
		            <span style="margin-right: 3%; margin-bottom:1%;">상품 사진</span> <br>
		            <span style="margin-right: 3%; margin-bottom:1%;">제품 사진</span> 
		            <input type="file" id="file1" name="file1" style="margin-bottom:1%;"/><br>
		            
		            <span style="margin-right: 3%; margin-bottom:1%;">첨부파일1</span> 
		            <input type="file" id="file2" name="file2" style="margin-bottom:1%;"/><br>
		            
		            <span style="margin-right: 3%; margin-bottom:1%;">첨부파일2</span> 
		            <input type="file" id="file2" name="file3" style="margin-bottom:1%;"/><br>
		            
		            <button type="button" onclick="input_goods2()" style="margin-left: 50%;" class="btn btn-info">상품등록</button>
	            </form>
            </div>
        </div>
    </div>
	...
	<!-- Footer-->
    <footer class="py-5" style="margin-top: 19%; height: 10%; background-color: #91d7cd; text-align: center;">
        <div class="container">
