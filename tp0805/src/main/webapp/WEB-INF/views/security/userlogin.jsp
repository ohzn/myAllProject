    ...
    <div class="col-4 test2">
		...
		<div class="row mb-3">
 		...
 		<div class="text-center">
    		<button type="button" class="btn btn-outline-info btn-block mb-4" onclick="go_join()">KIDULT 홈페이지 회원가입</button>
    		<p class="test3"></p>
		</div>
		</form>
		<hr />
		...
		<button type="submit" class="btn btn-primary btn-block mb-4" onclick="go_google()">Google로 로그인</button>
		<button type="submit" class="btn btn-warning btn-block mb-4" onclick="go_kakao()">Kakao로 로그인</button>
		<button type="submit" class="btn btn-success btn-block mb-4" onclick="go_naver()">Naver로 로그인</button>
	</div>
    <div class="col test1"></div>
</div>  
</div>
