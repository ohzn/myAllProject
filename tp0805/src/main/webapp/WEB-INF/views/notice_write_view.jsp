    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-6" style="margin-top: 40px; margin-left: 0px; float: left; outline: none;">
                <h2 style="margin-top: 16px; font-size: 17pt;"> 공지사항 쓰기 </h2>
	                ...
	                <form id="notice_frm">
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea type="text" class="form-control"
                                          ...
                                          style="width: 50%; height: 10%; margin-top: 30%;"> </textarea>
                                <script type="text/javascript">
									var oEditors = [];
                        ...
                        <tr>
                        	<td colspan="2" style="margin-top: 10%">
                        		<button type="button" class="btn btn-light" style="margin-left: 50%; float:left;" onclick="notice()">취소</button>
                    			<button type="button" class="btn btn-danger" style="float: left;" onclick="con_check()">글 올리기</button>
                        	</td>
                        </tr>
	            	</form>
                </table>
