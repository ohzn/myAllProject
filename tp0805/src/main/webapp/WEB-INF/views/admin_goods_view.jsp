...
<!-- End Header -->
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-7">
	            <h2 style="font-size: 18pt; margin-top: 5%;"> 상품 정보 확인 </h2> 
	            <hr style="margin-bottom: 0%;">
	            
				<table class="table">
					<tr>
						<td> 상품 번호 </td>
						<td colspan="4"> ${dto.cId} </td>
					</tr>
					<tr>
						<td> 상품 분류 </td>
						<td colspan="4"> ${dto.kind} </td>
					</tr>
					<tr>
						<td> 이름 </td>
						<td colspan="4"> ${dto.cName}</td>
					</tr>
					<tr>
						<td> 제목 </td>
				...
				<a href="javascript:response.sendRedirect('/member/qna_list');"> 목록보기 </a> &nbsp;&nbsp;
				 -->
				<button type="button" class="btn btn-primary btn-sm" onclick="qna_list()"> 상품 목록 </button> &nbsp;&nbsp;
				<c:if test="${uinfo.authority == 'ROLE_ADMIN'}"> 
					<a href="/admin/modify_goods?cId=${dto.cId}"> 정보 수정 </a>
				</c:if>
