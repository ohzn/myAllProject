...
<script>
    ...
    function submit_ajax(){
    	var queryString = $("#rep_frm").serialize();
    	$.ajax({
    		url: 'reply.do',
    		type: 'POST',
    		data: queryString,
        ...
        <div class="row">
            ...
            <div class="col-5 test2">
				<form id="rep_frm">
					...
					<input type="hidden" name="bMem" value="${reply_view.bMem}">
	            	...
	            	<div class="form-group">
	                	...
	                	<p class="info"><input type="text" id="bTitle" name="bTitle" value="re : ${reply_view.bTitle}"></p>
	              	</div>
	              	<hr>
	            	<div class="form-group">
	                	<label for="mId" class="tt">내용</label>
	                	<textarea id="bContent" name="bContent" rows="10" >${reply_view.bContent}</textarea>
	        		...
	        		<button type="button" class="btn btn-success mb-4 float-right" onclick="it_check()">답글 작성</button>
