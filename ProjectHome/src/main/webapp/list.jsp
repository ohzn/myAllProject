	...
	<div class="container">
        <div class="Pb-1">
        	<c:if test="${not empty sessionScope.id}">
        		<button type="button" class="btn float-right btn-warning" onclick="javascript:window.location='write_view.do'">글쓰기</button>
        	</c:if>
        </div>
        <p></p>
    </div>
        ...
        <table class="table table table-hover">
			...
			<tr>
                ...
                <td scope="col">
                    ...
                    <c:if test="${today - dtoDate le 1}"><!-- 1시간동안 new 표시 -->
