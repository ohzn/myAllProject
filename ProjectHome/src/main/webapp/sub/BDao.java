...
public class BDao
{
	...
	public int write(String bMem, String bTitle, String bContent, String bBoard) {
		int rn = 0;
		Connection con = null;
		...
		try {
			...
			String query = "insert into mem_board " + 
						   " (bId, bMem, bTitle, bContent, bHit, bGroup, bStep, bIndent, bGood, bBoard) " + 
						   " values " + 
	...
	public ArrayList<BDto> list(int curPage, String boardName){
		ArrayList<BDto> dtos = new ArrayList<BDto>();
		Connection con = null;
		PreparedStatement pstmt = null;
		ResultSet resultSet = null;
		System.out.println("in BDao : " + boardName);
		...
		try {
			...
			while(resultSet.next()) {
				...
				BDto dto = new BDto(bId, bMem, bTitle, bContent, bDate,
									bHit, bGroup, bStep, bIndent, bGood, c_number, bBoard);
	...
	public BPageInfo articlePage(int curPage, String boardName) {
		Connection con = null;
		PreparedStatement pstmt = null;
		ResultSet resultSet = null;
		...
		try {
			...
			String query = "select count(*) as total from mem_board where bBoard = ?";
			// 보드 이름 추가
			pstmt = con.prepareStatement(query);
			pstmt.setString(1, boardName);
			resultSet = pstmt.executeQuery();
...
//				pstmt.setString(1, "%" + searchContent + "%");
	...
	public String modify(String bId, String bMem, String bTitle, String bContent) {
		String contentNumber = bId;
		Connection con = null;
		PreparedStatement pstmt = null;
	...
	public void reply(String bId,String bMem,String bTitle,String bContent,
					  String bGroup,String bStep,String bIndent, String bBoard)
	{
		...
		try {
			...
			String query = "insert into mem_board " +
						   " (bId, bMem, bTitle, bContent, bGroup, bStep, bIndent, bGood, bBoard) " +
						   " values (mem_board_seq.nextval, ?, ?, ?, ?, ?, ?, 0, ?)";
			pstmt = con.prepareStatement(query);
