            ...
            <div class="col-5 test2">
				<form id="reg_frm">
	            	<div class="form-group">
	                	...
	                	<p class="info"><input type="text" id="bTitle" name="bTitle"></p>
	              	</div>
	              	<hr>
	            	<div class="form-group">
	        		...
	        		<button type="button" class="btn btn-success mb-4 float-right" onclick="it_check()">글 작성</button>
...
<table width="700" cellpadding="0" cellspacing="0" border="1">
		<form id="reg_frm">
		<input type="hidden" name="bBoard" value="게시판이름 가져와야함">
			<tr>
				<td> 글제목 </td>
			...
			<tr>
				<td colspan="2">
					<button type="button" onclick="it_check()">입력</button>
